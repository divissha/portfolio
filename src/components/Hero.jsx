  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-xl">
        ...
        <a
          href="#projects"
          className="inline-block px-8 py-3.5 mr-3 rounded-full font-bold text-ink bg-pink shadow-soft hover:-translate-y-1 transition-transform"
        >
          See my projects
        </a>
        ...
        <a
          ...
          href="/resume.pdf"
          download
          className="inline-block px-8 py-3.5 ml-3 rounded-full font-bold text-ink bg-pink shadow-soft hover:-translate-y-1 transition-transform"
        >
          Download Resume
        </a>
      </div>
